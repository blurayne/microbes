...
export const LOCALES = {
  ...
  rhe: {
    // Rheinhessisch (Region Nackenheim / Mainz / Worms) — etwas
    ...
    allow_pathogens: 'Krankheitserreger erlaube',
    pinch_rotation: 'Zwää-Finger-Drehung',
    virus_shader_3d: 'Virus-3D-Shader (experimentell)',
    fullscreen: 'Vollbild',
    shader_test_link: 'Shader-Test',
    game_mode: 'Schpielmodus',
    mode_free: 'Free Game',
    mode_campaign_soon: 'Kampagne (bald)',
    mode_survival_soon: 'Survival (bald)',
    ...
    audio: 'Audio',
    music_enabled: 'Musik',
    music_volume: 'Musiklautschtärke',
    sfx_volume: 'Effektlautschtärke',
    next_track: 'Nägscht Stück',
    random_split: 'Zufällische Teilung', meta_split: 'Metaball-Teilung',
    auto_split: 'Auto-Teilung (s)',
    friction: 'Reibung', bounce: 'Schprungkraft', throw_strength: 'Wurfkraft',
    ...
    renderer_webgl: 'WebGL2',
    renderer_webgpu: 'WebGPU',
    reset_sim: 'Simulation zurückschtelle',
    about: 'Iwwer', about_credits: 'Mitwirkende', about_licences: 'Drittanbieter-Lizenze', about_licences_note: 'Drei Shader-Assets folge der Shadertoy CC BY-NC-SA 3.0 Lizenz.', about_permissive: 'Permissive Portierunge', about_desc: '2D Mikrobe-Simulation.',
    help_title: 'Zelle vum Immunsyschtem',
    ...
    spawn_banner_friends: 'Gschwischderle', spawn_banner_prey: 'Beit', spawn_banner_foes: 'Feind', spawn_banner_close: 'Hab schun',
    palette_to_help: 'Was macht jede Zell? →',
    palette_bad_to_help: 'Was macht jeder Erreger? →',
    debug_log: 'Debug-Logbuch', clear: 'Lääre', copy: 'Kopiere',
    pause: 'Pause', paused: 'PAUSE',
    paused_hint: 'Leertasch oder Bildschirm zum Weiterschmadse',
    nav_settings: 'Eischtellunge', nav_help: 'Hilf', nav_add_cell: 'Zell dabbeschdun',
    nav_add_pathogen: 'Erreger dabbeschdun', nav_reload: 'Nei laade',
    adding: 'Dabbei: {name}',
    fps_line: '{fps} fps · Zelle {n}',
    help_group_good: 'Gut (Immunsyschtem)',
    blend_none: 'Kää', blend_overlay: 'Overlay (Schtandard)', blend_multiply: 'Multipliziere',
    blend_darken: 'Abdunkele', blend_lighter: 'Heller', blend_screen: 'Aufhelle',
    blend_softlight: 'Wääches Lischt', blend_hardlight: 'Harts Lischt',
    blend_burn: 'Nachbelischte', blend_dodge: 'Abwedele',
    upscale_blur: 'Wääschzeichne', upscale_pixel: 'Pixel (knackisch)',
    pgroup_virus: 'Viren', pgroup_bacteria: 'Bakterie',
    pgroup_parasite: 'Parasite', pgroup_fungus: 'Pilz', pgroup_toxin: 'Toxine',
    cell_neutrophil_label: 'Neutrophil',
    cell_neutrophil_desc: 'Erschte Verteidischung; verschlingt Bakterie per Phagozytose. Häufigschte weiße Blutzell.',
    cell_monocyte_label: 'Monozyt',
    cell_monocyte_desc: 'Wachposchte im Blut; werd im Gewebe zu Makrophage oder dendritische Zell.',
    cell_mast_label: 'Mastzell',
    cell_mast_desc: 'Gewebewächter; lässt Histamin raus un machd Entzündung un Allergie.',
    cell_nk_label: 'Natürlische Killerzell',
    cell_nk_desc: 'Patrouilliert nach virusinfizierte un Tumorzelle; macht\'se kalt ohne Vorprägung.',
    cell_macrophage_label: 'Makrophage',
    cell_macrophage_desc: '"Großfresser" — langlebischer Phagozyt; verdaut Erreger un weisd den T-Zelle die Antigene.',
    cell_dendritic_label: 'Dendritische Zell',
    cell_dendritic_desc: 'Antigen-präsentierender Kurier; bringt Erregerprobe zu de T-Zelle in de Lymphknote.',
    cell_basophil_label: 'Basophiler Granulozyt',
    cell_basophil_desc: 'Kreisender Granulozyt; lässt Histamin un Heparin raus un verschtärkt Entzündung.',
    cell_platelet_label: 'Blutplättsche',
    cell_platelet_desc: 'Winzisches Zellschdickelsche; gerinnt Blut an Wunne un hilft, Immunzelle herzubringe.',
    cell_tcell_label: 'T-Zell',
    cell_tcell_desc: 'Adaptiver Killer/Koordinator; erkennt schpezifische Antigene un macht infizierte Zelle kalt.',
    cell_bcell_label: 'B-Zell',
    cell_bcell_desc: 'Adaptive Antikörperfabrik; baut Antikörper, die zu jedem Erreger basse.',
    cell_eosinophil_label: 'Eosinophiler Granulozyt',
    cell_eosinophil_desc: 'Schpezialischt gege Parasite; wischtisch bei Allergie, lässt giftische Granule raus.',
    cell_rbc_label: 'Rote Blutzell',
    cell_rbc_desc: 'Erythrozyt; bikonkave Scheib voll Hämoglobin — bringt Sauerschdoff durch de Körper.',
    cell_virus_label: 'Virus',
    cell_virus_desc: 'Schpike-Eindringling; kabbert Zelle, dass\'a sisch do drin vermehrn kann.',
    cell_germ_label: 'Keim',
    cell_germ_desc: 'Allgemää knubbelische Mikrob — opportunistischer Erreger.',
    cell_bacterium_label: 'Bakterium',
    ...
    cell_mite_label: 'Milb',
    cell_mite_desc: 'Winzischer Krabbler; viel klää Bää.',
    cell_spore_label: 'Schpor',
    cell_spore_desc: 'Pilzschpor — treibt mit de Schtrömung un sät neies Wachschdum.',
    cell_toxin_label: 'Gift',
    cell_toxin_desc: 'Zackischer Giftkrischtall; treibt umme un brennt bei Kontakt.',
  },
  latin: {
