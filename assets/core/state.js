...
export const LOCALES = {
  ...
  de: {
    ...
    copy_settings:  'Einstellungen kopieren', toast_settings_copied:  'Einstellungen in Zwischenablage kopiert',
    save_settings:  'Einstellungen speichern', toast_settings_saved:   'Einstellungen als Datei gespeichert',
    apply_settings: 'Einstellungen anwenden', apply_settings_title:   'Einstellungen anwenden',
    apply_settings_hint:    'Den JSON-Text aus Kopieren/Speichern einfügen und Anwenden klicken. Die Seite lädt neu, um den neuen Zustand zu übernehmen.',
    apply_settings_confirm: 'Anwenden',
    toast_settings_applied: 'Einstellungen angewendet — wird neu geladen',
    toast_settings_dump_failed:  'Ausgeben fehlgeschlagen',
    toast_settings_apply_failed: 'Anwenden fehlgeschlagen — kein gültiges JSON',
    cancel: 'Abbrechen',
    ...
    about: 'Über', links: 'Links', about_credits: 'Mitwirkende', about_licences: 'Drittanbieter-Lizenzen', about_licences_note: 'Drei Shader-Assets stehen unter der Shadertoy-Standardlizenz CC BY-NC-SA 3.0 (NichtKommerziell + ShareAlike). Müssten ersetzt werden, falls das Projekt jemals unter eine permissive Lizenz gestellt wird.', about_permissive: 'Permissive Portierungen', about_desc: 'Eine 2D-Mikroben-Simulation — Phagozyten, Lymphozyten und die Erreger, die sie jagen.', about_project_licence: 'Projektlizenz', about_project_licence_note: 'Microbes steht unter der GNU General Public License v3.0. Vollständiger Text in der Datei LICENSE im Wurzelverzeichnis.', about_soundtracks: 'Soundtracks', about_soundtracks_note: 'Soundtracks werden mit dem Projekt ausgeliefert und stehen unter der GPL v3 (siehe oben). SFX folgen denselben Bedingungen.',
    ...
    debug: 'Debug', clear: 'Leeren', copy: 'Kopieren',
    pause: 'Pause', paused: 'PAUSE',
    ...
    help_group_good: 'Immunsystem & Körper',
  ...
  es: {
    ...
    about: 'Acerca de', links: 'Enlaces', about_credits: 'Créditos', about_licences: 'Licencias de terceros', about_licences_note: 'Tres recursos de shader llevan la licencia Shadertoy CC BY-NC-SA 3.0.', about_permissive: 'Portes permisivos', about_desc: 'Simulación 2D de microbios.', about_project_licence: 'Licencia del proyecto', about_project_licence_note: 'Microbes se publica bajo la GNU General Public License v3.0. Texto completo en el archivo LICENSE.', about_soundtracks: 'Bandas sonoras', about_soundtracks_note: 'Las bandas sonoras se distribuyen con el proyecto y están cubiertas por la GPL v3 indicada arriba.',
    ...
    debug: 'Depuración', clear: 'Limpiar', copy: 'Copiar',
    ...
    help_group_good: 'Sistema inmunitario y cuerpo',
  ...
  bar: {
    ...
    about: 'Iwa', links: 'Links', about_credits: 'Mitwirkn', about_licences: 'Lizenzn', about_licences_note: 'Drei Shader-Assets miassn Shadertoy-Standard-Lizenz folgn.', about_permissive: 'Permissive', about_desc: '2D-Mikrobnsimulation.', about_project_licence: 'Projektlizenz', about_project_licence_note: 'Microbes is unta da GNU General Public License v3.0. Voiständiger Text in da Datei LICENSE.', about_soundtracks: 'Soundtracks', about_soundtracks_note: 'Soundtracks san unta der GPL v3 wia oben.',
    ...
    debug: 'Debug', clear: 'Leara', copy: 'Kopiern',
    pause: 'Pause', paused: 'PAUSE',
    ...
    help_group_good: 'Immunsystem & Körpa',
  ...
  hes: {
    ...
    about: 'Iwwer', links: 'Links', about_credits: 'Mitwirkende', about_licences: 'Drittanbieter-Lizenze', about_licences_note: 'Drei Shader-Assets folge der Shadertoy CC BY-NC-SA 3.0 Lizenz.', about_permissive: 'Permissive Portierunge', about_desc: '2D Mikrobe-Simulation.', about_project_licence: 'Projektlizenz', about_project_licence_note: 'Microbes is unner de GNU General Public License v3.0. Voller Text in LICENSE.', about_soundtracks: 'Soundtracks', about_soundtracks_note: 'Soundtracks sin unner de GPL v3 wie owwe.',
    ...
    debug: 'Debug', clear: 'Lääre', copy: 'Kopiere',
    pause: 'Pause', paused: 'PAUSE',
  ...
  latin: {
    ...
    about: 'De projecto', links: 'Nexus', about_credits: 'Auctores', about_licences: 'Licentiae alienae', about_licences_note: 'Tres pelliculae sub licentia Shadertoy CC BY-NC-SA 3.0 sunt.', about_permissive: 'Translationes permissivae', about_desc: 'Simulatio microborum bidimensionalis.', about_project_licence: 'Licentia projecti', about_project_licence_note: 'Microbes sub GNU General Public License v3.0 editur. Plenus textus in tabula LICENSE.', about_soundtracks: 'Symphoniae', about_soundtracks_note: 'Symphoniae cum projecto distribuuntur, sub eadem GPL v3.',
    ...
    debug: 'Debugatio', clear: 'Vacua', copy: 'Describe',
    ...
    help_group_good: 'Systema immunitarium et corpus',
