...
export const LOCALES = {
  en: {
    ...
    dump_settings: 'Dump settings', toast_settings_dumped: 'Settings dumped to console + clipboard', toast_settings_dump_failed: 'Settings dump failed',
  ...
  de: {
    ...
    dump_settings: 'Einstellungen ausgeben', toast_settings_dumped: 'Einstellungen in Konsole + Zwischenablage kopiert', toast_settings_dump_failed: 'Ausgeben fehlgeschlagen',
