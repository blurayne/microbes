// Vendored reference: frag-sphere.glsl
// Source: https://github.com/jagracar/webgl-shader-examples
// File:   WebContent/shaders/frag-sphere.glsl
// Author: jagracar
// License: see upstream repo.
//
// Vendored as documentation alongside vert-sphere.glsl. The actual
// in-game implementation (gated by `S.virusShader3D`) lives in the
// disk shaders of webgl2.js + webgpu.js — adapted from this Three.js
// 3D-sphere model to our 2D disk pipeline.
